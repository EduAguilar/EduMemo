...
public class VentanaInicial extends JFrame{
    ...
    private void initComponets() {
        ...
        setTitle("EduMemo");//Titulo de la ventana.
        setResizable(false);
        ...
        ImagenInicial.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/CerebroEjercicio.gif"))); 
        ...
        TituloInicial.setText("EDU MEMOTEST V. 1.0");
    ...
    private void JugarSalirActionPerformed(java.awt.event.ActionEvent evt) {                                           
        setVisible(false);
        JOptionPane.showMessageDialog(this,"Esta es una aplicación creada para la materia Laboratorio de Leguaje 0."
                + "\n Carrera Técnico Superior en Desarrollo de Sistemas \n Instituto Superior Capacitas - S.C Bariloche "
                + "\n               07/06/2016. \n Prof. Daniel Fratte \n                Autor: Aguilar Eduardo Alfredo.", "Gracias! - Espero lo haya disfrutado.",JOptionPane.INFORMATION_MESSAGE, null);
        System.exit(0);
    }
    ...
    private void AcercaDeActionPerformed(ActionEvent evt) {
        JOptionPane.showMessageDialog(this,"Esta es una aplicación creada para la materia Laboratorio de Leguaje 0."
                + "\n Carrera Técnico Superior en Desarrollo de Sistemas \n Instituto Superior Capacitas - S.C Bariloche "
                + "\n               07/06/2016. \n Prof. Daniel Fratte \n                Autor: Aguilar Eduardo Alfredo.", "Acerca de EduMemo - Aguilar Eduardo Alfredo.",JOptionPane.INFORMATION_MESSAGE, null);
    }
    ...
    private void TutorialActionPerformed(ActionEvent evt) {
        ...
        JOptionPane.showMessageDialog(this,"*En este juego debe tratar de recordar la ubicación de cada imagen y ubicar su pareja."
                ...
                + "\n*Si lo desea podrá cambiar de nivel de dificultad o de categoria.", "Instruciones del juego - Aguilar Eduardo Alfredo.",JOptionPane.INFORMATION_MESSAGE, null);
    }
